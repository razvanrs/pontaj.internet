<template>
    <button :disabled="disabled" :class="{'text-slate-300': disabled, 'cursor-not-allowed': disabled}" v-html="variants[props.type]" />
</template>
...
const props = defineProps({
    type: {
        type: String,
        validator (value) {
            return ['action', 'view', 'edit', 'delete', 'forceDelete', 'restore'].includes(value)
        },
    },
    disabled: {
        type: Boolean,
...
const variants = {
    action: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5"> <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM12.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM18.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" /> </svg> ',
